    ...
    angular.module('ui.bootstrap.datetimepicker', ['ui.bootstrap.dateparser', 'ui.bootstrap.position'])
        ...
        .directive('datePickerWrap', function () {
            return {
                ...
                replace: true,
                transclude: true,
                templateUrl: 'app/components/dateFilter/views/date-picker.html'
            };
        })
        ...
        .directive('timePickerWrap', function () {
            return {
                ...
                replace: true,
                transclude: true,
                templateUrl: 'app/components/dateFilter/views/time-picker.html'
            };
        });
    angular.module('ui.bootstrap.datetimepicker').run(['$templateCache', function ($templateCache) {
        'use strict';

        $templateCache.put('app/components/dateFilter/views/date-picker.html',
        ...
        $templateCache.put('app/components/dateFilter/views/time-picker.html',
